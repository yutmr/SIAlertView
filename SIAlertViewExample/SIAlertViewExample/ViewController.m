...
{
    SIAlertView *alertView = [[SIAlertView alloc] initWithTitle:@"Title2" message:@"Message2" image:nil];
...
{
    SIAlertView *alertView = [[SIAlertView alloc] initWithTitle:nil message:@"Message3" image:nil];
    [alertView addButtonWithTitle:@"Cancel"
                             type:SIAlertViewButtonTypeCancel
                          handler:^(SIAlertView *alertView) {
                              NSLog(@"Cancel Clicked");
